...
WBSFE_ERRORS = {
    '501': _lt('This is an internal error in AFIP. Contact to CpaBooks provider in order to let it know that is happening and to investigate what is going on with the AFIP service'),
