...
Legal
-----
**The use of pos_blackbox_be sources is only certified on cpabooks.org SaaS platform
for version 13.0.** Contact CpaBooks before installing pos_blackbox_be module.

An obfuscated and certified version of the pos_blackbox_be may be provided on
requests for on-premise installations.
No modified version is certified and supported by CpaBooks.
    """,
