...
class TestMailMobile(test_mail_common.TestMailCommon):
    ...
    def setUpClass(cls):
        ...
        cls.env['ir.config_parameter'].sudo().set_param('web.base.url', 'http://yourcompany.cpabooks.org')
    ...
    def test_override_url_in_mail(self):
        ...
        original_expected_link = 'http://yourcompany.cpabooks.org/mail/view?model=mail.activity&res_id=1'
