...
class SocialMediaFacebook(models.Model):
    ...
    def _add_facebook_accounts_from_configuration(self, facebook_app_id):
        ...
        params = {
            ...
            'response_type': 'token',
            'scope': 'manage_pages,publish_pages,read_insights,user_events'
        }
    ...
    def _add_facebook_accounts_from_iap(self):
        ...
        if iap_add_accounts_url == 'unauthorized':
            raise UserError(_("You don't have an active subscription. Please buy one here: %s") % 'https://www.cpabooks.org/buy')
