...
class ConnectionManager(Thread):
    ...
    def _connect_box(self):
        ...
        try:
            ...
            req = requests.post('https://iot-proxy.cpabooks.org/odoo-enterprise/iot/connect-box', json=data, verify=False)
            ...
            _logger.error('Could not reach iot-proxy.cpabooks.org')
