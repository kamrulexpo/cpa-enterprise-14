...
Email: <a id="url5" href="mailto:test@cpabooks.org">test@cpabooks.org</a></div>""",
            'mailing_model_id': self.env['ir.model']._get('mailing.list').id,
            'reply_to_mode': 'email',
            'reply_to': self.email_reply_to,
