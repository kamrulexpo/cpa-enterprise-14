...
ERROR_MESSAGES = {
    ...
    '423': _lt("No Account Found (423): We were unable to detect an account. Please verify that you account information is available at this time and If the problem persists, please contact customer support at online@cpabooks.org for further assistance."),
...
class YodleeProviderAccount(models.Model):
    ...
    def _get_yodlee_credentials(self):
        ...
        base_url = self.sudo().env['ir.config_parameter'].get_param('odoo.online_sync_proxy') or 'https://onlinesync.cpabooks.org'
