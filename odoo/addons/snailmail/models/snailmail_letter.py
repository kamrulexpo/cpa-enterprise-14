...
DEFAULT_ENDPOINT = 'https://iap-snailmail.cpabooks.org'
...
class SnailmailLetter(models.Model):
    ...
    def _get_error_message(self, error):
        ...
        if error == 'TRIAL_ERROR':
            ...
            return _('You don\'t have an IAP account registered for this service.<br>Please go to <a href=%s target="new">iap.cpabooks.org</a> to claim your free credits.', link)
