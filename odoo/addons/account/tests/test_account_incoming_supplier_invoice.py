...
class TestAccountIncomingSupplierInvoice(AccountTestInvoicingCommon):
    ...
    def setUpClass(cls, chart_template_ref=None):
        ...
        cls.env['ir.config_parameter'].sudo().set_param('mail.catchall.domain', 'test-company.cpabooks.org')

        cls.internal_user = cls.env['res.users'].create({
            'name': 'Internal User',
            'login': 'internal.user@test.cpabooks.org',
            'email': 'internal.user@test.cpabooks.org',
        })
