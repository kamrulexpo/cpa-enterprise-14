...
class MailMail(models.Model):
    ...
    auto_delete = fields.Boolean(
        'Auto Delete',
        help="This option permanently removes any track of email after send, including from the Technical menu in the Settings, in order to preserve storage space of CpaBooks database.")
